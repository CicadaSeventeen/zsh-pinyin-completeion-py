...
first_letter_unicode = lambda x: "".join(word[0] for word in x.split())
first_letter_unicode_upper = lambda x: "".join(word[0].upper() for word in x.split())
first_letter_unicode_lower = lambda x: "".join(word[0].lower() for word in x.split())
full = "full"
Full = "Full"
FUll = "FUll"
FuLl = "FuLl"
...
def string_convert(string,converter_chinese=None,converter_other=identity,heteronym="auto",style=None,strict=False,converter=None,extra_arg=None):
...
string_convert_chinese = string_convert
